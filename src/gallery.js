  ...
  return (
    <div className="gallery">
      <div className="main-gallery-photo">
          <img src={verticalGalleryImg} alt="image of mixed media artwork"></img>
      ...
      <div className="main-gallery-photo">
          <img src={verticalGalleryImgTwo} alt="image of a collage"></img>
          <div className="gallery-txt">
      ...
      <div className="main-gallery-photo">
          <img src={verticalGalleryImgTwo} alt="image of an oil painting"></img>
          <div className="gallery-txt">
